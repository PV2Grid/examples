...
func (d *SumDistiller) LeadNanos() int64 {
	return 1000000000
}
...
func (d *SumDistiller) Rebase() distil.Rebaser {
...
func (d *SumDistiller) Process(in *distil.InputSet, out *distil.OutputSet) {
	/* Output 0 is freq_1s.
	...
	var i int
	for i = 0; i < ns; i++ {
		var v1s float64 = (in.Get(0, i).V + in.Get(1, i).V)
